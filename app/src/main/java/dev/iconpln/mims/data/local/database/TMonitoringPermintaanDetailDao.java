...
public class TMonitoringPermintaanDetailDao extends AbstractDao<TMonitoringPermintaanDetail, Long> {
    ...
    public static class Properties {
        ...
        public final static Property NomorMaterial = new Property(3, String.class, "NomorMaterial", false, "NOMOR_MATERIAL");
        public final static Property Unit = new Property(4, String.class, "Unit", false, "UNIT");
        public final static Property QtyPermintaan = new Property(5, String.class, "QtyPermintaan", false, "QTY_PERMINTAAN");
        public final static Property MaterialDesc = new Property(6, String.class, "MaterialDesc", false, "MATERIAL_DESC");
        public final static Property QtyScan = new Property(7, String.class, "QtyScan", false, "QTY_SCAN");
        public final static Property Kategori = new Property(8, String.class, "Kategori", false, "KATEGORI");
        public final static Property QtyPengeluaran = new Property(9, String.class, "QtyPengeluaran", false, "QTY_PENGELUARAN");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TMONITORING_PERMINTAAN_DETAIL\" (" + //
                ...
                "\"NOMOR_MATERIAL\" TEXT," + // 3: NomorMaterial
                "\"UNIT\" TEXT," + // 4: Unit
                "\"QTY_PERMINTAAN\" TEXT," + // 5: QtyPermintaan
                "\"MATERIAL_DESC\" TEXT," + // 6: MaterialDesc
                "\"QTY_SCAN\" TEXT," + // 7: QtyScan
                "\"KATEGORI\" TEXT," + // 8: Kategori
                "\"QTY_PENGELUARAN\" TEXT);"); // 9: QtyPengeluaran
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, TMonitoringPermintaanDetail entity) {
        ...
        if (NomorMaterial != null) {
            stmt.bindString(4, NomorMaterial);
        }
    ...
    public TMonitoringPermintaanDetail readEntity(Cursor cursor, int offset) {
        TMonitoringPermintaanDetail entity = new TMonitoringPermintaanDetail( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // NomorMaterial
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // Unit
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // QtyPermintaan
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // MaterialDesc
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // QtyScan
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // Kategori
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9) // QtyPengeluaran
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TMonitoringPermintaanDetail entity, int offset) {
        ...
        entity.setNomorMaterial(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setUnit(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setQtyPermintaan(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setMaterialDesc(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setQtyScan(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setKategori(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
        entity.setQtyPengeluaran(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
     }
