...
class PemeriksaanUlpSnAdapter(val lisModels: MutableList<TListSnMaterialPenerimaanUlp>, var listener: OnAdapterListener)
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ItemSnPemeriksaanUlpBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ViewHolder(val binding: ItemSnPemeriksaanUlpBinding): RecyclerView.ViewHolder(binding.root){
