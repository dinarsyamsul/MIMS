...
/** 
 * DAO for table "TTRANS_DETAIL_PENERIMAAN_ULP".
*/
public class TTransDetailPenerimaanUlpDao extends AbstractDao<TTransDetailPenerimaanUlp, Long> {

    public static final String TABLENAME = "TTRANS_DETAIL_PENERIMAAN_ULP";

    /**
     * Properties of entity TTransDetailPenerimaanUlp.<br/>
    ...
    public TTransDetailPenerimaanUlpDao(DaoConfig config) {
        super(config);
    }
    
    public TTransDetailPenerimaanUlpDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TTRANS_DETAIL_PENERIMAAN_ULP\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TTRANS_DETAIL_PENERIMAAN_ULP\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TTransDetailPenerimaanUlp entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TTransDetailPenerimaanUlp entity) {
        stmt.clearBindings();
    ...
    @Override
    public TTransDetailPenerimaanUlp readEntity(Cursor cursor, int offset) {
        TTransDetailPenerimaanUlp entity = new TTransDetailPenerimaanUlp( //
    ...
    @Override
    public void readEntity(Cursor cursor, TTransDetailPenerimaanUlp entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TTransDetailPenerimaanUlp entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TTransDetailPenerimaanUlp entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TTransDetailPenerimaanUlp entity) {
