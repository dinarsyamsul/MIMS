...
/** 
 * DAO for table "TPOS_DETAIL".
*/
public class TPosDetailDao extends AbstractDao<TPosDetail, Long> {

    public static final String TABLENAME = "TPOS_DETAIL";

    /**
     * Properties of entity TPosDetail.<br/>
    ...
    public TPosDetailDao(DaoConfig config) {
        super(config);
    }
    
    public TPosDetailDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TPOS_DETAIL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TPOS_DETAIL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TPosDetail entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TPosDetail entity) {
        stmt.clearBindings();
    ...
    @Override
    public TPosDetail readEntity(Cursor cursor, int offset) {
        TPosDetail entity = new TPosDetail( //
    ...
    @Override
    public void readEntity(Cursor cursor, TPosDetail entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TPosDetail entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TPosDetail entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TPosDetail entity) {
