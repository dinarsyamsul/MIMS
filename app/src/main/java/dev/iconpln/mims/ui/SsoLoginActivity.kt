            ...
            when(it.message){
                "DO LOGIN" -> {
                    CoroutineScope(Dispatchers.IO).launch {
                        ...
                        SharedPrefsUtils.setStringPreference(this@SsoLoginActivity, "fullName", it.user?.fullName!!)
                        SharedPrefsUtils.setStringPreference(this@SsoLoginActivity, "roleName", it.user?.roleName!!)
                        ...
                        SharedPrefsUtils.setStringPreference(this@SsoLoginActivity, "plantName", it.user?.plantName!!)
                        SharedPrefsUtils.setStringPreference(this@SsoLoginActivity, "storloc", it.user?.storloc!!)
                        SharedPrefsUtils.setStringPreference(this@SsoLoginActivity, "storlocName", it.user?.storLocName!!)
