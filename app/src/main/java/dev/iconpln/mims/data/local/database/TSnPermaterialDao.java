...
/** 
 * DAO for table "TSN_PERMATERIAL".
*/
public class TSnPermaterialDao extends AbstractDao<TSnPermaterial, Long> {

    public static final String TABLENAME = "TSN_PERMATERIAL";

    /**
     * Properties of entity TSnPermaterial.<br/>
    ...
    public TSnPermaterialDao(DaoConfig config) {
        super(config);
    }
    
    public TSnPermaterialDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TSN_PERMATERIAL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TSN_PERMATERIAL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TSnPermaterial entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TSnPermaterial entity) {
        stmt.clearBindings();
    ...
    @Override
    public TSnPermaterial readEntity(Cursor cursor, int offset) {
        TSnPermaterial entity = new TSnPermaterial( //
    ...
    @Override
    public void readEntity(Cursor cursor, TSnPermaterial entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TSnPermaterial entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TSnPermaterial entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TSnPermaterial entity) {
