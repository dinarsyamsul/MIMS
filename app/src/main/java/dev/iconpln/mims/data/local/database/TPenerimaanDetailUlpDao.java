...
/** 
 * DAO for table "TPENERIMAAN_DETAIL_ULP".
*/
public class TPenerimaanDetailUlpDao extends AbstractDao<TPenerimaanDetailUlp, Long> {

    public static final String TABLENAME = "TPENERIMAAN_DETAIL_ULP";

    /**
     * Properties of entity TPenerimaanDetailUlp.<br/>
    ...
    public TPenerimaanDetailUlpDao(DaoConfig config) {
        super(config);
    }
    
    public TPenerimaanDetailUlpDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TPENERIMAAN_DETAIL_ULP\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TPENERIMAAN_DETAIL_ULP\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TPenerimaanDetailUlp entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TPenerimaanDetailUlp entity) {
        stmt.clearBindings();
    ...
    @Override
    public TPenerimaanDetailUlp readEntity(Cursor cursor, int offset) {
        TPenerimaanDetailUlp entity = new TPenerimaanDetailUlp( //
    ...
    @Override
    public void readEntity(Cursor cursor, TPenerimaanDetailUlp entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TPenerimaanDetailUlp entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TPenerimaanDetailUlp entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TPenerimaanDetailUlp entity) {
